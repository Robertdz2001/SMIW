...
# Date: Thu, 18 Jul 2024 12:18:07 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/periclk}] -edges {1 101 201} [list [get_pins {ClockBlock/ff_div_12}]]
